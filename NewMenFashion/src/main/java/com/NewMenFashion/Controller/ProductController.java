...
import com.NewMenFashion.Service.CategoryService;
...
public String saveProduct(@Valid @ModelAttribute(value="product") Product product, BindingResult result, Model model){
	...
	if(!prodImage.isEmpty()){
		Path paths=
Paths.get("C:\\Users\\Diljeet\\Desktop\\NewMenFashion\\NewMenFashion\\src\\main\\webapp\\Resources\\Images\\"+ product.getpId()+".png");
	try {
